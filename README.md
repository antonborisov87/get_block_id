# get_block_id
get_block_id is a collection of utilities for interacting with Web3 and Ethereum smart contracts.
...
You can get_block_id Project via npm:

```bash
npm install get_block_id
```
## Usage

const Web3Tools = require('get_block_id');
